# Generated by Powerlevel10k configuration wizard on 2025-06-08 at 16:58 CEST.
...
() {
  ...
  # Set current directory color
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$blue
  if [[ -n "$IN_NIX_SHELL" ]]; then
    typeset -g POWERLEVEL9K_DIR_FOREGROUND=$green
  fi

  # Use the Nix snowflake icon instead of the word "Nix" for Nix shells.
  typeset -g POWERLEVEL9K_NIX_SHELL_VISUAL_IDENTIFIER_EXPANSION='' # This is the NerdFont Nix icon
  typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION=''
  typeset -g POWERLEVEL9K_NIX_SHELL_FOREGROUND='#7ebae4'
  ...
  typeset -g POWERLEVEL9K_VCS_GIT_HOOKS=(vcs-detect-changes git-untracked git-aheadbehind git-staged)
